...
class MuZeroConfig:
    def __init__(self):
        ...
        self.training_steps = 9000000  # Total number of training steps (ie weights update according to a batch)
...
class Game(AbstractGame):
    ...
    def to_play(self):
        ...
        """
        return 0 if self.env.player == BLACK else 1
